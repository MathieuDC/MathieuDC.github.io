...
function handleClickMenu() {
    const sidenavEl = document.getElementById('mdc-sidenav')
    const navEl = document.getElementById('mdc-nav-container')
    if(!sidenavEl.classList.contains('displaying')){
        navIsScrolling = navEl.classList.contains('is-scrolling')
        sidenavEl.classList.add('displaying');
        if(navIsScrolling){
            navEl.classList.remove('is-scrolling')
        }
    }else{
        sidenavEl.classList.remove('displaying');
        if(navIsScrolling){
            navEl.classList.add('is-scrolling')
        }
    }
    document.getElementById('mdc-menu-button').classList.toggle('active')
    document.getElementById('mdc-menu-button').classList.toggle('not-active')
    document.getElementById('mdc-container').classList.toggle('sidenav-displaying')
...
document.addEventListener('swup:clickLink', (event) => {
    ...
    else if (path.includes('expertise')) {
